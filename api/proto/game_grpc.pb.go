...
const (
	GameService_Connect_FullMethodName         = "/game.v1.GameService/Connect"
	GameService_Disconnect_FullMethodName      = "/game.v1.GameService/Disconnect"
	GameService_Move_FullMethodName            = "/game.v1.GameService/Move"
	GameService_Attack_FullMethodName          = "/game.v1.GameService/Attack"
	GameService_Retreat_FullMethodName         = "/game.v1.GameService/Retreat"
...
func (c *gameServiceClient) Connect(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (*ConnectResponse, error) {
	...
	err := c.cc.Invoke(ctx, GameService_Connect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameServiceClient) Disconnect(ctx context.Context, in *DisconnectRequest, opts ...grpc.CallOption) (*DisconnectResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DisconnectResponse)
	err := c.cc.Invoke(ctx, GameService_Disconnect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameServiceClient) Retreat(ctx context.Context, in *RetreatRequest, opts ...grpc.CallOption) (*RetreatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RetreatResponse)
	err := c.cc.Invoke(ctx, GameService_Retreat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameServiceClient) GetPlayerStatus(ctx context.Context, in *GetPlayerStatusRequest, opts ...grpc.CallOption) (*GetPlayerStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *gameServiceClient) GetMap(ctx context.Context, in *GetMapRequest, opts ...grpc.CallOption) (*GetMapResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGameServiceServer) Disconnect(context.Context, *DisconnectRequest) (*DisconnectResponse, error) {
...
func (UnimplementedGameServiceServer) Retreat(context.Context, *RetreatRequest) (*RetreatResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Retreat not implemented")
}
func (UnimplementedGameServiceServer) GetPlayerStatus(context.Context, *GetPlayerStatusRequest) (*GetPlayerStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPlayerStatus not implemented")
}
func (UnimplementedGameServiceServer) GetMap(context.Context, *GetMapRequest) (*GetMapResponse, error) {
...
func _GameService_Disconnect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServiceServer).Disconnect(ctx, req.(*DisconnectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GameService_Retreat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetreatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GameServiceServer).Retreat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GameService_Retreat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServiceServer).Retreat(ctx, req.(*RetreatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GameService_GetPlayerStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServiceServer).GetPlayerStatus(ctx, req.(*GetPlayerStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GameService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Retreat",
			Handler:    _GameService_Retreat_Handler,
		},
		{
